...
export const ACTION_LABELS: Record<string, { label: string; color: string }> = {
  ...
  DOCUMENT_REQUESTED: { label: "Document oficial emis", color: "text-violet-600" },
  DOCUMENT_RENEWED: { label: "Document reînnoit", color: "text-blue-600" },
...
export const ACTION_STYLE: Record<string, { block: string; ring: string; line: string }> = {
  ...
  DOCUMENT_REQUESTED: { block: "bg-violet-600", ring: "ring-violet-200", line: "from-violet-200 to-violet-400" },
  DOCUMENT_RENEWED: { block: "bg-blue-500", ring: "ring-blue-200", line: "from-blue-200 to-blue-400" },
